...
iterations = 20  # number of independent simulation runs (overall results are average) for all three functions
...
# Parallel execution might still cause problems (apparently only works when just one of the figures is generated)
# The issue seems to be related to matplotlib
